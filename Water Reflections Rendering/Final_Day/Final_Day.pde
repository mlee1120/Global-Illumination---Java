/**
 * This file illustates Final_Day.pde.
 *
...
void setup() {
  ...
  lights_i.add(new float[]{1.2, 1.2, 1.2});
  ...
  temp = new Primitive("plane", new float[]{0.0, 0.0, 180.0}, new float[]{1080.0, 0.0, 630.0, 1.0}, new float[]{30.0, 30.0, 30.0}, 0.5, 0.5, 0.3, 30.0, 0.15, 0.0, 1.0);
  temp.ifTexture = true;
  ...
  temp.ifTexture = true;
  temp.texture = loadImage("sky.png");
  objects.add(temp);
