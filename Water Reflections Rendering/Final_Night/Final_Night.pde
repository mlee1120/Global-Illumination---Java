...
void setup() {
  ...
  //objects.add(new Primitive("sphere", new float[]{0.0, 135.0, -60.0}, new float[]{360.0}, new float[]{30.0, 30.0, 30.0}, 0.5, 0.5, 0.3, 30.0, 0.0, 0.9, 1.2));
